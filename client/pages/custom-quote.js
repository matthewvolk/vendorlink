...
export default withRouter(props => {
  ...
  return (
    <Layout title={`Submit a free quote | VendorLink`}>
      <section className="container">
        <h1>
          Contact{" "}
          {(() => {
            if (props.router.query.vendor)
              return `${props.router.query.vendor}`;
          })(props)}
        </h1>
