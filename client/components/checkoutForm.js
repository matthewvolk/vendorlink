...
const CheckoutForm = ({ subTotal, productNames, stripe }) => {
  ...
  return (
    <section>
      ...
      <div>
        <span>
          <strong>Tax</strong>: ${(SUBTOTAL * TAX_RATE).toFixed(2)}
        </span>
      </div>
      <div>
        <span>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          <strong>Test Credit Card:</strong> 4242 4242 4242 4242
        </div>
        <div>
          <strong>Test Credit Card with insufficient funds:</strong> 4000 0000
          0000 9995
        </div>
        <br />
