  ...
  render () {
    return (
      <>
        <section className="modal">
          <div className="pad">
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <br/>
              <br/>
              <p style={{color: "rgb(25, 118, 181)"}}>@todo add password confirmation</p>
              <p style={{color: "rgb(25, 118, 181)"}}>@todo CORS for Firefox: Cross-Origin Request Blocked: The Same Origin Policy disallows reading the remote resource at http://localhost:3001/api/v1/auth/user/create. (Reason: missing token ‘content-type’ in CORS header ‘Access-Control-Allow-Headers’ from CORS preflight channel).</p>
        ...
        <style jsx>{`
          .modal {
            border: 1px solid rgb(25, 118, 181);
            border-radius: 5px;
